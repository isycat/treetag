modifier_treant_blink_lua = class({})

--------------------------------------------------------------------------------

function modifier_treant_blink_lua:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_treant_blink_lua:OnCreated( kv )
	if IsServer() then
...
function modifier_treant_blink_lua:OnDestroy()
	if IsServer() then
...
function modifier_treant_blink_lua:OnIntervalThink()
	if IsServer() then
		--StopSoundOn( "Hero_Furion.Teleport_Grow", self:GetCaster() )
		--StopSoundOn( "Hero_Furion.Teleport_Grow", self:GetCaster() )
