treant_blink_lua = class({})
LinkLuaModifier( "modifier_treant_blink_lua", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------

function treant_blink_lua:OnAbilityPhaseStart()
	...
	self:GetCaster():AddNewModifier( self:GetCaster(), self, "modifier_treant_blink_lua", kv )
...
function treant_blink_lua:OnAbilityPhaseInterrupted()
	...
	self:GetCaster():RemoveModifierByName( "modifier_treant_blink_lua" )
...
function treant_blink_lua:OnSpellStart()
