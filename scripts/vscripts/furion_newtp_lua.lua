furion_newtp_lua = class({})
LinkLuaModifier( "modifier_furion_newtp_lua", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------

function furion_newtp_lua:OnAbilityPhaseStart()
	...
	self:GetCaster():AddNewModifier( self:GetCaster(), self, "modifier_furion_newtp_lua", kv )
...
function furion_newtp_lua:OnAbilityPhaseInterrupted()
	...
	self:GetCaster():RemoveModifierByName( "modifier_furion_newtp_lua" )
...
function furion_newtp_lua:OnSpellStart()
