modifier_furion_newtp_lua = class({})

--------------------------------------------------------------------------------

function modifier_furion_newtp_lua:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_furion_newtp_lua:OnCreated( kv )
	if IsServer() then
...
function modifier_furion_newtp_lua:OnDestroy()
	if IsServer() then
...
function modifier_furion_newtp_lua:OnIntervalThink()
	if IsServer() then
		StopSoundOn( "Hero_Furion.Teleport_Grow", self:GetCaster() )
		StopSoundOn( "Hero_Furion.Teleport_Grow", self:GetCaster() )
